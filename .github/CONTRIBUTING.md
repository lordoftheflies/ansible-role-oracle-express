...
## Contributing to Ansible Role: Oracle Express Database Engine
...
If you need an answer, you can either:
  ...
  2. If you need a faster response, either join [the Telegram group](https://t.me/joinchat/BgcHHE-NwwWNnnnu2Bnl-Q) or [the Slack channel](https://cherubits.slack.com/) and ask your question there
...
[issue section](https://gitlab.cherubits.hu/oss/ansible-galaxy-roles/ansible-role-oracle-express/issues).
